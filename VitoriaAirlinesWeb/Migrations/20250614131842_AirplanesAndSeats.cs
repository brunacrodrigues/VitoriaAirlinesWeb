...
{
    /// <inheritdoc />
    public partial class AirplanesAndSeats : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalExecutiveSeats = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_AirplaneId_Row_Letter",
                table: "Seats",
                columns: new[] { "AirplaneId", "Row", "Letter" },
                unique: true);
        }
